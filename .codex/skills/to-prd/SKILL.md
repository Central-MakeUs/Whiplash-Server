---
name: to-prd
description: 이 저장소에서 기능 요청, 정책 변경, API 변경, 앱 요구사항을 docs/history/{0001}-{기능명-slug}/PLAN.md 형식의 PRD 또는 구현 계획으로 정리할 때 사용한다.
---
...
- 기존 `docs/history/{0001}-{기능명-slug}/PLAN.md` 흐름과 맞춘다.
...
- 문서를 실제로 생성할 때는 기존 `docs/history/` 번호 순서를 확인한 뒤 다음 4자리 번호를 사용한다.
