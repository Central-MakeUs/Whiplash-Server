...
public class AdSessionServiceImpl implements AdSessionService {
    ...
    public AdSessionEntity createSession(
        ...
        return createSession(member, alarm, null, deviceId, purpose, expiresAt);
    }
    ...
    public AdSessionEntity createSession(
        ...
        return adSessionRepository.save(AdSessionEntity.builder()
            ...
            .member(member)
            .alarm(alarm)
            .alarmOccurrence(alarmOccurrence)
            .deviceId(deviceId)
            .purpose(purpose)
    ...
    public AdSessionEntity getSessionTarget(String adSessionId) {
        return adSessionRepository.findByAdSessionId(adSessionId)
            .orElseThrow(() -> ApplicationException.from(AdErrorCode.AD_SESSION_NOT_FOUND));
    }
    ...
    public AdSessionEntity getVerifiedSessionForConsume(
        ...
        return getVerifiedSessionForConsume(adSessionId, memberId, alarmId, deviceId, purpose, null);
    }
    ...
    public AdSessionEntity getVerifiedSessionForConsume(
        ...
        AdSessionEntity adSession = adSessionRepository.findByAdSessionIdForUpdate(adSessionId)
            .orElseThrow(() -> ApplicationException.from(AdErrorCode.AD_SESSION_NOT_FOUND));
        adSession.validateForConsume(memberId, alarmId, deviceId, purpose, occurrenceId, timeProvider.now());
        return adSession;
    }
}
