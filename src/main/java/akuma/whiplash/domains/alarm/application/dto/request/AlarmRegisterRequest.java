...
public record AlarmRegisterRequest(
    ...
    // TODO: MONDAY~SUNDAY 요일 검증 필요
    @Schema(description = "반복 요일 코드 리스트 (MONDAY~SUNDAY)", example = "[\"MONDAY\", \"WEDNESDAY\", \"FRIDAY\"]")
    ...
    @Schema(description = "알람 소리 코드", example = "KARINA_SCOLDING")
